...
public static class EnumerableExtensions
{
    ...
    static IEnumerable<TSource> WhereIterator<TSource>(
    ...
    static Func<TSource, bool> CombinePredicates<TSource>(
    ...
    static Func<TSource, TResult> CombineSelectors<TSource, TMiddle, TResult>(
    ...
    class WhereEnumerableIterator<TSource> : Iterator<TSource>
    {
        ...
        {
            return new WhereEnumerableIterator<TSource>(
                source,
    ...
    class WhereArrayIterator<TSource> : Iterator<TSource>
    {
        ...
        public override IEnumerable<TSource> Where(Func<TSource, bool> predicate)
        {
            return new WhereArrayIterator<TSource>(
                source,
                CombinePredicates(this.predicate, predicate)
            );
        }
    ...
    class SelectEnumerableIterator<TSource, TResult> : Iterator<TResult>, IIListProvider<TResult>
    {
        ...
        {
            return new SelectEnumerableIterator<TSource, TResult2>(
                _source,
    ...
    class WhereSelectEnumerableIterator<TSource, TResult> : Iterator<TResult>
    {
        ...
        public override IEnumerable<TResult2> Select<TResult2>(Func<TResult, TResult2> selector)
        {
            return new WhereSelectEnumerableIterator<TSource, TResult2>(
                source,
                predicate,
    ...
    class WhereSelectArrayIterator<TSource, TResult> : Iterator<TResult>
    {
        ...
        public override IEnumerable<TResult2> Select<TResult2>(Func<TResult, TResult2> selector)
        {
            return new WhereSelectArrayIterator<TSource, TResult2>(
                source,
                predicate,
                CombineSelectors(this.selector, selector)
            );
    ...
    class WhereSelectListIterator<TSource, TResult> : Iterator<TResult>
    {
        ...
        public override IEnumerable<TResult2> Select<TResult2>(Func<TResult, TResult2> selector)
        {
            return new WhereSelectListIterator<TSource, TResult2>(
                source,
                predicate,
                CombineSelectors(this.selector, selector)
            );
    ...
    static IEnumerable<TResult> SelectManyIterator<TSource, TResult>(
        IEnumerable<TSource> source,
        Func<TSource, IEnumerable<TResult>> selector
    )
    {
    ...
    )
    {
        ...
        return SelectManyIterator<TSource, TCollection, TResult>(
            source,
            collectionSelector,
            resultSelector
        );
    ...
    static IEnumerable<TResult> SelectManyIterator<TSource, TCollection, TResult>(
        IEnumerable<TSource> source,
        Func<TSource, int, IEnumerable<TCollection>> collectionSelector,
        Func<TSource, TCollection, TResult> resultSelector
    )
    ...
    static IEnumerable<TSource> TakeWhileIterator<TSource>(
        IEnumerable<TSource> source,
        Func<TSource, bool> predicate
    )
    {
    ...
    static IEnumerable<TSource> SkipWhileIterator<TSource>(
        IEnumerable<TSource> source,
        Func<TSource, bool> predicate
    )
    {
    ...
    static IEnumerable<TResult> JoinIterator<TOuter, TInner, TKey, TResult>(
    ...
    )
    {
        ...
        if (resultSelector == null)
            throw new ArgumentNullException("resultSelector");
        return GroupJoinIterator<TOuter, TInner, TKey, TResult>(
            outer,
            inner,
            outerKeySelector,
            innerKeySelector,
    ...
    static IEnumerable<TResult> GroupJoinIterator<TOuter, TInner, TKey, TResult>(
        IEnumerable<TOuter> outer,
        IEnumerable<TInner> inner,
        Func<TOuter, TKey> outerKeySelector,
        Func<TInner, TKey> innerKeySelector,
    ...
    {
        return new GroupedEnumerable<TSource, TKey, TElement>(
            source,
            keySelector,
            elementSelector,
            null
    ...
    static IEnumerable<TSource> ConcatIterator<TSource>(
    ...
    static IEnumerable<TResult> ZipIterator<TFirst, TSecond, TResult>(
    ...
    static IEnumerable<TSource> UnionIterator<TSource>(
        IEnumerable<TSource> first,
        IEnumerable<TSource> second,
        IEqualityComparer<TSource> comparer
    )
    ...
    static IEnumerable<TSource> IntersectIterator<TSource>(
        IEnumerable<TSource> first,
        IEnumerable<TSource> second,
        IEqualityComparer<TSource> comparer
    )
    ...
    {
        return ToDictionary<TSource, TKey, TSource>(
            source,
            keySelector,
            IdentityFunction<TSource>.Instance,
            null
    ...
    static IEnumerable<TSource> DefaultIfEmptyIterator<TSource>(
        IEnumerable<TSource> source,
        TSource defaultValue
    )
    {
    ...
    public static double Min(this IEnumerable<double> source)
    {
        ...
        foreach (double x in source)
        {
            if (hasValue)
            {
                if (x < value || System.Double.IsNaN(x))
                    value = x;
            }
            else
            {
    ...
    public static double? Min(this IEnumerable<double?> source)
    {
        ...
        foreach (double? x in source)
        {
            if (x == null)
                continue;
            if (value == null || x < value || System.Double.IsNaN((double)x))
                value = x;
        }
        return value;
    }
    ...
    public static double Max(this IEnumerable<double> source)
    {
        ...
        foreach (double x in source)
        {
            if (hasValue)
            {
                if (x > value || System.Double.IsNaN(value))
                    value = x;
            }
            else
            {
    ...
    public static double? Max(this IEnumerable<double?> source)
    {
        ...
        foreach (double? x in source)
        {
            if (x == null)
                continue;
            if (value == null || x > value || System.Double.IsNaN((double)value))
                value = x;
        }
        return value;
    }
...
internal class GroupedEnumerable<TSource, TKey, TElement, TResult> : IEnumerable<TResult>
{
    ...
    {
        Lookup<TKey, TElement> lookup = Lookup<TKey, TElement>.Create<TSource>(
            source,
            keySelector,
            elementSelector,
            comparer
...
internal class GroupedEnumerable<TSource, TKey, TElement> : IEnumerable<IGrouping<TKey, TElement>>
{
    ...
    public IEnumerator<IGrouping<TKey, TElement>> GetEnumerator()
    {
        return Lookup<TKey, TElement>
            .Create<TSource>(source, keySelector, elementSelector, comparer)
            .GetEnumerator();
    }
...
internal abstract class OrderedEnumerable<TElement> : IOrderedEnumerable<TElement>
{
    ...
    {
        OrderedEnumerable<TElement, TKey> result = new OrderedEnumerable<TElement, TKey>(
            source,
            keySelector,
            comparer,
            descending
